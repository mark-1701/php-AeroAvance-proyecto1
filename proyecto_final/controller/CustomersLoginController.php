...
class CustomersLoginController
{
    private $model;
    ...
    {
        require_once("view/customers_login/login.php");
    }

    static function recoverPassword()
    {
        require_once("view/customers_login/recover_password.php");
    }

    static function singUp()
    {
        require_once("view/customers_login/sing_up.php");
    }
    ...
    static function Acceder()
    {
        ...
        $data = "type='cliente' AND email='$email' AND password='$password'";
        $model = new LoginModel();
        $dato = $model->authentication("users", $data);
        if ($dato) {
            header("location:" . mainvuelos);
        } else {
    ...
    static function Recuperar()
    {
        ...
        header("location:" . urlcustomerslogin);
    }
    ...
    static function Registrarse()
    {
        ...
        $data = "'cliente', '$name', '$email', '$password', 'activo'";
        $model = new LoginModel();
