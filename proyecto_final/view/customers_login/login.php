...
<div class="myContainer">
    ...
    <form class="form">
        ...
        <a href="customers_login.php?m=recoverPassword" id="recoverPassword">¿Olvidaste tu contraseña?</a>
        <br><br>
        <input type="submit" name="m" value="Acceder" class="btn btn-primary">
        <a href="customers_login.php?m=singUp" id="singUp">Crear una cuenta</a>
    </form>
